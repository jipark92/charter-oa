...
export const transactionMockData = [
    {
        ...
        customerID: 123,
        price: 890,
        rewardPoints: calculateRewardPoints(890),
    ...
    },
    {
        ...
        customerID: 123,
        price: 50,
        rewardPoints: calculateRewardPoints(50),
    ...
    },
    {
        ...
        purchasedDate: new Date("July 14, 22 ").toDateString(),
    },
    {
        transactionID: 13,
        customerID: 123,
        ...
        purchasedDate: new Date("May 13, 22 ").toDateString(),
    },
    {
        transactionID: 14,
        customerID: 789,
        price: 1231,
        rewardPoints: calculateRewardPoints(1231),
        purchasedDate: new Date("May 13, 22 ").toDateString(),
    },
];
